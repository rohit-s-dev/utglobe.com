...
<body>
	<!--loader-->
       ...
       <blockquote class="dark-bg"> <h1 class="text-center">Web Hosting Services</h1></blockquote>
      ...
      <div class="row">
        <div class="col-md-6 col-sm-12">
        	<div class="about__content">
        		<h2>Web Hosting </h2>
        		<p class="text-justify">The internet has transformed business marketing. No matter what you do, the internet is likely to be at the heart of your marketing strategy.
...
Internet marketing, or online marketing, refers to advertising and marketing efforts that use the Web and email to drive direct sales via electronic commerce, in addition to sales leads from Web sites or emails. Internet marketing and online advertising efforts are typically used in conjunction with traditional types of advertising such as radio, television, newspapers and magazines.</p>
        ...
        <div class="col-md-6 col-sm-12">
          <div class="office__block">
          	<figure> <img src="assets/img/webhosting.jpg" class="img-thumbnail img-responsive" /></figure>
